...
public class BookingParisHouseTest {
    ...
    public void booking1Test() throws InterruptedException {
        ...
        String maxPrice = BaseSteps.findElementGetText(driver, "//*[@id=\"filter_price\"]//a[5]")
                .replaceAll("\\D+", "");
        String firstPrice = BaseSteps.findElementGetText(driver, "//*[contains(@class, " +
                "\"bui-price-display\")]/div[2]/div").replaceAll("\\D+", "");
